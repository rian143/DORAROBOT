class Config(object):
  ...
  # Optional fields
    ...
    DRAGONS = [5656382791 5377566421 1813463956 1932082654]  # User id of sudo users
    DEV_USERS = [5656382791 5377566421 1813463956 1932082654]  # User id of dev users
    DEMONS = [5656382791 5377566421 1813463956 1932082654]  # User id of support users
    TIGERS = [5656382791 5377566421 1813463956 1932082654]  # User id of tiger users
    WOLVES = [5656382791 5377566421 1813463956 1932082654]  # User id of whitelist users

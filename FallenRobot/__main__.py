...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="✘ᴏᴜʀ ɴᴇᴛᴡᴏʀᴋ✘", url=f"https://t.me/wariornetwork"),
    ],
]
        ...
        if mod_match:
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="✘ ᴄʟᴏꜱᴇ ✘", callback_data="help_back")]]
                ),
            )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="✘sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ✘", callback_data="fallen_support"
                        ),
                        InlineKeyboardButton(
...
ᴡʀɪᴛᴛᴇɴ ɪɴ ᴩʏᴛʜᴏɴ ᴡɪᴛʜ ᴛʜᴇ ʜᴇʟᴩ ᴏғ : [ᴛᴇʟᴇᴛʜᴏɴ](https://t.me/wariornetwork)
[ᴩʏʀᴏɢʀᴀᴍ](https://t.me/vivekevil)
[ᴩʏᴛʜᴏɴ-ᴛᴇʟᴇɢʀᴀᴍ-ʙᴏᴛ](https://t.me/pirokid)
